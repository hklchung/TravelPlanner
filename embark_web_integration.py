# step 1: get user info and preference
# step 1.5: get user Google map client (not done)
# step 2: select the random 5 hotspot based on user preference
# step 3: user select the first location
# step 4: iteratively recommend random 5 hospots based on first selected
# step 5: print the itinerary to user
# Optional: 
# step 6: allow the user to adjust the itinerary (not done)
